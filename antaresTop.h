const uint16_t stripLength = 228;
const uint8_t nStrips = 3;
const uint16_t num_leds = stripLength * nStrips;

#define LEDS_OUTPUT1 stripLength
#define LEDS_OUTPUT2 stripLength
#define LEDS_OUTPUT3 stripLength
...
//    FastLED.addLeds<WS2813, DATA_PIN_2, RGB>(outLeds, 600, 360); 
    ...
    ArduinoOTA.setHostname("antaresTop");
}
