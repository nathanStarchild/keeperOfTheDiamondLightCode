...
DEFINE_GRADIENT_PALETTE( metal_gold_002_gp ) {
  // Gradient palette "metal_gold_002_gp", originally from
  // http://soliton.vm.bytemark.co.uk/pub/cpt-city/ocal/tn/metal-gold-002.png.index.html
  // converted for FastLED with gammas (2.6, 2.2, 2.5)
...
// Gradient palette "bhw1_bloooo_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/bhw/bhw1/tn/bhw1_bloooo.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
