...
#define LEDS_OUTPUT1 stripLength * 12
//#define LEDS_OUTPUT2 stripLength * 5
//#define LEDS_OUTPUT3 stripLength * 5
...
void elementSetup(){
    FastLED.addLeds<WS2813, DATA_PIN_2, RGB>(outLeds, 0, LEDS_OUTPUT1); 
...
//    FastLED.addLeds<WS2813, DATA_PIN_2, RGB>(outLeds, 600, 360); 
    ...
    ArduinoOTA.setHostname("hexBaseFull");
}
